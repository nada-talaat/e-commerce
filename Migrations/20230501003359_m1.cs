    ...
    public partial class m1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    ID = table.Column<int>(type: "int", nullable: false),
                    Discount_name = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    Discount_percent = table.Column<decimal>(type: "decimal(10,2)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    ID = table.Column<int>(type: "int", nullable: false),
                    Size_name = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ColorProduct", x => new { x.Color_id, x.Product_id });
                    table.ForeignKey(
                        name: "FK_ColorProduct_Color_Color_id",
                        column: x => x.Color_id,
                        principalTable: "Color",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ColorProduct_Product_Product_id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ColorProduct_Product_id",
                table: "ColorProduct",
                column: "Product_id");
